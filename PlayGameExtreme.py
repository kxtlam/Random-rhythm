...
import sys
import random
from pygame.constants import K_c, K_x        
...
def displayBackground (screen):
    normalBg = pygame.image.load ("Images\Bg 6 lanes.png")             
...
def getImage (x):
    if x == 367 or x == 722:
        blockImage = pygame.image.load ("Images\Pink block.png")        
    
    elif x == 250 or x == 485 or x == 604 or x == 841:
        blockImage = pygame.image.load ("Images\Blue block.png")        
        blockImage = pygame.transform.scale (blockImage, (116,27))
...
#Main game loop#
def playGameE (screen, pressed,score):               
    while pressed:                                   
        ...
        while allBlockPos [349][1] < 800:                
            while lives > 0:   
                ...
                for a in range (350):                
                    ...
                    a+= 1           #Increments a to the next block
                ...
                for b in range (350):
                    ...
                    #Detecting if the correct keyboard key was pressed for each lane   
                    if 662 <= block.y <= 690:                      
                        for event in pygame.event.get ():
                            ...
                            if event.type == pygame.KEYDOWN:        
                                ...
                                if block.x == 841:
                                    ...
                                    elif keyPressed != [K_COMMA]:
                                        lives = lives - 1
                                        if combo > highestCombo:
                                            highestCombo = combo 
                                        combo = 0
                    b += 1                                                              #Increments b and moves onto the next block from the list allBlocks
